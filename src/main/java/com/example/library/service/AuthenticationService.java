...
public interface AuthenticationService {
    ...
    ApiResponse<AuthenticationResponse> refreshToken(RefreshRequest request) throws JOSEException, ParseException;
    ApiResponse<UserResponse> profile();
    ApiResponse<Void> logout(LogoutRequest request)  throws ParseException, JOSEException;
    ApiResponse<AuthenticationResponse> verifyOtpAndLogin(VerifyOtpRequest request);
}
