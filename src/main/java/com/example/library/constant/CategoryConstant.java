...
public class CategoryConstant {
    public static final String CODE = "Mã loại sách";
    public static final String CODE_LENGTH = "100";
    public static final String NAME = "Tên loại sách";
    ...
    public static final String CATEGORY = "Loại sách";
    public static final String PARENT_CATEGORY = "Loại sách cha";
