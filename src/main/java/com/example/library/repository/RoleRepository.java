...
public interface RoleRepository extends JpaRepository<Role, Long>, JpaSpecificationExecutor<Role> {
    ...
    List<Role> searchExport(@Param("code") String code, @Param("name") String name,
                            @Param("listPermission") Set<Long> listPermission, @Param("status") Long status);
